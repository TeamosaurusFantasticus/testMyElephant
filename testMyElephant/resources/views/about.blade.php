...
<html lang="en">
    ...
    <div class="aboutPage">
            ...
            <div class="aboutContent bgWhite">
                ...
                <p>
                    La première version du site testMyElephant a été développé par quatres codeurs (Claire, Gaël, Thibaut et Alix)
                    dans le cadre d'un projet de groupe de l'organisme de formation IT-AKADEMY lors de la formation Développeur Full-stack 2020-2021.
                ...
                <p>testMyElephant fonctionne grâce à deux procédés : nous clonons le repository sur notre serveur le temps de le traiter,
                    puis nous le scannons grâce à la librairie <a href="https://github.com/designsecurity/progpilot">PROGPILOT</a> qui déterminera s'il y a des failles de sécurité dans le code PHP.</p><br>
                <h3 class="bold">Où trouver des informations sur les failles de sécurité?</h3><br>
                <p>Voici plusieurs sites de référence en la matière :
                    <ul>
